...
class Basica extends PluginTask {
    
    public $time = 151;
    public $ids = array(/** Armaduras */298,299,300,301,305,304,303,302,/** Espadas */267,272,/** Ferramentas */257,258,274,275,/** Itens */295,17,263,264,266,265,260);
    ...
    /** Itens */
    if($id == 295 or $id == 17 or $id == 263 or $id == 264 or $id == 266 or $id == 265 or $id == 260){
        
    $item->setDamage(0);
    $item->setCount(rand(10,30));
        
    }
    
    /** Armaduras */
    if($id == 298 or $id == 299 or $id == 300 or $id == 301 or $id == 305 or $id == 304 or $id == 303 or $id == 302){
    ...
    /** Ferramentas */  
    if($id == 257 or $id == 258 or $id == 274 or $id == 275){
