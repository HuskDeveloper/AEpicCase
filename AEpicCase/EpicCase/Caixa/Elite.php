...
class Elite extends PluginTask {
    
    public $time = 151;
    public $ids = array(/** Armaduras */310,311,312,313,/** Espadas */276,/** Ferramentas */278,279,/** Arco */261,/** Itens */133,57,41,42,466,322,383,421);
    ...
    if(!$this->chest instanceof Player){
    ...
    /** Itens */
    if($id == 133 or $id == 57 or $id == 41 or $id == 42){
